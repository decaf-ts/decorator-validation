(function webpackUniversalModuleDefinition(root, factory) {
  ...
  this,
  (
    __WEBPACK_EXTERNAL_MODULE__1024__,
    __WEBPACK_EXTERNAL_MODULE__2947__,
    __WEBPACK_EXTERNAL_MODULE__3911__,
    __WEBPACK_EXTERNAL_MODULE__6333__
  ) => {
    return /******/ (() => {
      // webpackBootstrap
          ...
          class MultiselectPrompt extends Prompt {
            ...
            renderOption(cursor, v, i, arrowIndicator) {
              ...
              if (v.disabled) {
                ...
                title =
                  cursor === i ? color.cyan().underline(v.title) : v.title;
        ...
        /***/ 674: /***/ (
          ...
          class StyledString {
            constructor(text) {
              this.text = text;
              // Basic colors
              Object.entries(constants_1.StandardForegroundColors).forEach(
                ([name, code]) => {
              ...
              Object.entries(constants_1.BrightForegroundColors).forEach(
                ([name, code]) => {
                  Object.defineProperty(this, name, {
                    get: () => this.foreground(code),
                  });
              ...
              // Background colors
              Object.entries(constants_1.StandardBackgroundColors).forEach(
                ([name, code]) => {
                  Object.defineProperty(this, name, {
              ...
              Object.entries(constants_1.BrightBackgroundColors).forEach(
                ([name, code]) => {
                  Object.defineProperty(this, name, {
                    get: () => this.background(code),
                  });
...
#`.split("\n");
            ...
            banner.forEach((line, index) => {
              (logger ? logger.info.bind(logger) : console.log.bind(console))(
                (0, styled_string_builder_1.style)(line || "").raw(
                  colors[index]
                ).text
              );
            });
          ...
          function getSlogan(i) {
            try {
              i =
                typeof i === "undefined"
                  ? Math.floor(Math.random() * slogans_json_1.default.length)
                  : i;
        ...
        /***/ 1394: /***/ (module) => {
          ...
          const $ = {
            enabled:
              !NODE_DISABLE_COLORS && TERM !== "dumb" && FORCE_COLOR !== "0",
        ...
        /***/ 1679: /***/ (
          ...
          class AutocompletePrompt extends Prompt {
            ...
            renderOption(v, hovered, isStart, isEnd) {
              ...
              prefix =
                (hovered ? color.cyan(figures.pointer) + " " : "  ") + prefix;
          ...
          class ReleaseScript extends command_1.Command {
            ...
            async prepareVersion(tag) {
              ...
              if (!tag) {
                ...
                await (0, utils_1.runCommand)(
                  "git tag --sort=-taggerdate | head -n 5"
                ).promise;
                return await input_1.UserInput.insistForText(
                  "tag",
            ...
            async run(args) {
              ...
              result = await (0, utils_1.runCommand)(
                `npm run prepare-release -- ${tag} ${message}`,
                {
                  cwd: process.cwd(),
                }
              ).promise;
              result = await (0, utils_1.runCommand)("git status --porcelain")
                .promise;
              await result;
              if (
                result.logs.length &&
                (await input_1.UserInput.askConfirmation(
                  "git-changes",
                ...
                await (0, utils_1.runCommand)(
                  `git commit -m "${tag} - ${message} - after release preparation${ci ? "" : constants_1.NoCIFLag}"`
                ).promise;
              }
              await (0, utils_1.runCommand)(
                `npm version "${tag}" -m "${message}${ci ? "" : constants_1.NoCIFLag}"`
              ).promise;
...
Filtered results for: ${this.inputValue ? this.inputValue : color.gray("Enter something to filter")}\n`;
        ...
        /***/ 3340: /***/ function (
          ...
          function getPackage(p = process.cwd(), property) {
            ...
            try {
              pkg = JSON.parse(
                readFile(path_1.default.join(p, `package.json`))
              );
            } catch (error) {
              throw new Error(
                `Failed to retrieve package information" ${error}`
              );
            }
            if (property) {
              if (!(property in pkg))
                throw new Error(
                  `Property "${property}" not found in package.json`
                );
              return pkg[property];
            }
            return pkg;
          ...
          function setPackageAttribute(attr, value, p = process.cwd()) {
            ...
            pkg[attr] = value;
            writeFile(
              path_1.default.join(p, `package.json`),
          ...
          async function getDependencies(path = process.cwd()) {
            ...
            try {
              pkg = JSON.parse(
                await (0, utils_1.runCommand)(`npm ls --json`, { cwd: path })
                  .promise
              );
            } catch (e) {
          ...
          async function pushToGit() {
            ...
            const gitUser = await (0, utils_1.runCommand)(
              "git config user.name"
            ).promise;
            const gitEmail = await (0, utils_1.runCommand)(
              "git config user.email"
            ).promise;
            log.verbose(
              `cached git id: ${gitUser}/${gitEmail}. changing to automation`
            );
            await (0, utils_1.runCommand)(
              'git config user.email "automation@decaf.ts"'
            ).promise;
            await (0, utils_1.runCommand)('git config user.name "decaf"')
              .promise;
            log.info("Pushing changes to git...");
            await (0, utils_1.runCommand)("git add .").promise;
            await (0, utils_1.runCommand)(
              `git commit -m "refs #1 - after repo setup"`
            ).promise;
            await (0, utils_1.runCommand)("git push").promise;
            await (0, utils_1.runCommand)(`git config user.email "${gitEmail}"`)
              .promise;
            await (0, utils_1.runCommand)(`git config user.name "${gitUser}"`)
              .promise;
          ...
          async function installDependencies(dependencies) {
            ...
            if (prod.length) {
              ...
              await (0, utils_1.runCommand)(`npm install ${prod.join(" ")}`, {
                cwd: process.cwd(),
              }).promise;
            }
            if (dev.length) {
            ...
            if (peer.length) {
              ...
              await (0, utils_1.runCommand)(
                `npm install --save-peer ${peer.join(" ")}`,
                {
                  cwd: process.cwd(),
                }
              ).promise;
        ...
        /***/ 3741: /***/ (__unused_webpack_module, exports) => {
          "use strict";
        ...
        /***/ 3874: /***/ (__unused_webpack_module, exports) => {
          "use strict";
        ...
        /***/ 3885: /***/ (__unused_webpack_module, exports) => {
          "use strict";
          ...
          class TemplateSync extends command_1.Command {
            ...
            async downloadOption(key) {
              ...
              for (const file of files) {
                ...
                let data = await utils_1.HttpClient.downloadFile(
                  `${baseUrl}/${file}`
                );
            ...
            async getLicense(license) {
              ...
              data = (0, utils_1.patchString)(data, this.replacements);
              (0, utils_1.writeFile)(
                path_1.default.join(process.cwd(), "LICENSE.md"),
                data
              );
            ...
            async updatePackageScrips() {
              try {
                const originalPkg = JSON.parse(
                  await utils_1.HttpClient.downloadFile(
                ...
                Object.keys(pkg.scripts).forEach((key) => {
                  if (key in scripts) {
                    const replaced = (0, utils_1.patchString)(
                      scripts[key],
                      this.replacements
                    );
            ...
            async createTokenFiles() {
              ...
              const gitToken = await input_1.UserInput.insistForText(
                "token",
              ...
              Object.values(utils_1.Tokens).forEach((token) => {
                try {
                  ...
                  try {
                    ...
                    log.info(
                      `Token file ${token} not found. Creating a new one...`
                    );
                    fs_1.default.writeFileSync(
                      token,
                      token === ".token" ? gitToken : ""
                    );
                    return;
                  }
                  if (!status) {
            ...
            async auditFix() {
              return await (0, utils_1.runCommand)("npm audit fix --force")
                .promise;
            }
            patchFiles() {
              const files = [
                ...fs_1.default
                  ...
                  .map((entry) =>
                    path_1.default.join(entry.parentPath, entry.name)
                  ),
                ...fs_1.default
            ...
            async run(args) {
              ...
              if (boot) {
                ...
                const name = await input_1.UserInput.insistForText(
                  "Project name",
                  "Enter the project name:",
                  (res) => res.length > 1
                );
                const author = await input_1.UserInput.insistForText(
                  "Author",
              ...
              if (typeof scripts === "undefined")
                scripts = await input_1.UserInput.askConfirmation(
                  "scripts",
              ...
              if (!all && typeof license === "undefined") {
                ...
                if (confirmation)
                  license = await input_1.UserInput.insistForText(
                    "license",
                    "Enter the desired License (MIT|GPL|Apache|LGPL|AGPL):",
                    (val) =>
                      !!val && !!val.match(/^(MIT|GPL|Apache|LGPL|AGPL)$/g)
                  );
              }
              if (typeof license !== "undefined")
                await this.getLicense(license);
              if (typeof ide === "undefined")
                ide = await input_1.UserInput.askConfirmation(
                  "ide",
              ...
              if (typeof typescript === "undefined")
                typescript = await input_1.UserInput.askConfirmation(
                  "typescript",
              ...
              if (typeof docker === "undefined")
                docker = await input_1.UserInput.askConfirmation(
                  "docker",
              ...
              if (typeof automation === "undefined")
                automation = await input_1.UserInput.askConfirmation(
                  "automation",
              ...
              if (typeof styles === "undefined")
                styles = await input_1.UserInput.askConfirmation(
                  "styles",
              ...
              if (typeof docs === "undefined")
                docs = await input_1.UserInput.askConfirmation(
                  "docs",
              ...
              if (typeof workflows === "undefined")
                workflows = await input_1.UserInput.askConfirmation(
                  "workflows",
              ...
              if (typeof templates === "undefined")
                templates = await input_1.UserInput.askConfirmation(
                  "templates",
              ...
              if (typeof pkg === "undefined")
                pkg = await input_1.UserInput.askConfirmation(
                  "pkg",
              ...
              if (typeof tests === "undefined")
                tests = await input_1.UserInput.askConfirmation(
                  "pkg",
              ...
              if (typeof dependencies === "undefined")
                dependencies = await input_1.UserInput.askConfirmation(
                  "pkg",
        ...
        /***/ 4747: /***/ function (
          ...
          class HttpClient {
            static {
              this.log = logging_1.Logging.for(HttpClient);
            }
            /**
        ...
        /***/ 4785: /***/ (
          ...
          class TextPrompt extends Prompt {
            ...
            isCursorAtStart() {
              return (
                this.cursor === 0 || (this.placeholder && this.cursor === 1)
              );
            }
        ...
        /***/ 6471: /***/ (__unused_webpack_module, exports) => {
          "use strict";
        ...
        /***/ 6686: /***/ (
          ...
          function spawnCommand(output, command, opts, abort, logger) {
            ...
            if (command.includes(" | ")) {
              ...
              for (let i = 0; i < cmds.length; i++) {
                if (i !== 0)
                  controllers[i] = chainAbortController(
                    controllers[i - 1].signal
                  );
          ...
          function runCommand(
            command,
            opts = {},
            outputConstructor = StandardOutputWriter_1.StandardOutputWriter,
            ...args
          ) {
            ...
            const lock = new Promise((resolve, reject) => {
              ...
              try {
                ...
                return reject(
                  new Error(`Error running command ${command}: ${e}`)
                );
              }
        ...
        /***/ 6837: /***/ (__unused_webpack_module, exports) => {
          "use strict";
           ...
           */
          exports.DefaultCommandValues = Object.keys(
            exports.DefaultCommandOptions
          ).reduce((acc, key) => {
...
Filtered results for: ${this.inputValue ? this.inputValue : color.gray("Enter something to filter")}\n`;
        ...
        /***/ 7154: /***/ (__unused_webpack_module, exports) => {
          ...
          exports.AbortCode =
            ...
            exports.LogLevel =
            exports.Tokens =
            exports.SetupScriptKey =
            exports.NoCIFLag =
            exports.SemVersion =
            exports.SemVersionRegex =
            exports.Encoding =
              void 0;
          /**
        ...
        /***/ 7714: /***/ function (
          ...
          class UserInput {
            static {
              this.logger = logging_1.Logging.for(UserInput);
            }
            /**
             ...
             */
            setChoices(value) {
              UserInput.logger.verbose(
                `Setting choices: ${JSON.stringify(value)}`
              );
              this.choices = value;
              return this;
            }
            ...
            static async ask(question) {
              ...
              try {
                ...
                log.verbose(
                  `Received answers: ${JSON.stringify(answers, null, 2)}`
                );
              } catch (error) {
        ...
        /***/ 8564: /***/ (
          ...
          function colorizeANSI(text, n, bg = false) {
            if (isNaN(n)) {
              console.warn(
                `Invalid color number on the ANSI scale: ${n}. ignoring...`
              );
              return text;
            }
            if (bg && ((n > 30 && n <= 40) || (n > 90 && n <= 100))) {
              n = n + 10;
            }
          ...
          function colorize256(text, n, bg = false) {
            if (isNaN(n)) {
              console.warn(
                `Invalid color number on the 256 scale: ${n}. ignoring...`
              );
              return text;
            }
            if (n < 0 || n > 255) {
          ...
          function colorizeRGB(text, r, g, b, bg = false) {
            if (isNaN(r) || isNaN(g) || isNaN(b)) {
              console.warn(
                `Invalid RGB color values: r=${r}, g=${g}, b=${b}. Ignoring...`
              );
              return text;
            }
          ...
          class StandardOutputWriter {
            ...
            log(type, data) {
              data = Buffer.isBuffer(data)
                ? data.toString(constants_1.Encoding)
                : data;
              const formatedType =
                type === "stderr"
                  ? (0, styled_string_builder_1.style)("ERROR").red.text
                  : type;
            ...
            exit(code, logs) {
              this.log(
                "stdout",
                `command exited code : ${code === 0 ? (0, styled_string_builder_1.style)(code.toString()).green.text : (0, styled_string_builder_1.style)(code === null ? "null" : code.toString()).red.text}`
              );
              if (code === 0) {
                this.resolve(logs.map((l) => l.trim()).join("\n"));
              } else {
                this.reject(
                  new Error(logs.length ? logs.join("\n") : code.toString())
                );
              }
            }
            /**
            ...
            resolve(reason) {
              this.log(
                "stdout",
                `${this.cmd} executed successfully: ${(0, styled_string_builder_1.style)(reason ? "ran to completion" : reason).green}`
              );
            ...
            reject(reason) {
              ...
              this.log(
                "stderr",
                `${this.cmd} failed to execute: ${(0, styled_string_builder_1.style)(reason.message).red}`
              );
          ...
          class Command {
            constructor(name, inputs = {}, requirements = []) {
              ...
              this.inputs = Object.assign(
                {},
                constants_2.DefaultCommandOptions,
                inputs
              );
            }
            /**
            ...
            async execute() {
              ...
              const env = environment_1.Environment.accumulate(
              ...
              if (banner)
                (0, common_1.printBanner)(
                  this.log.for(common_1.printBanner, {
                    timestamp: false,
                    style: false,
                    context: false,
                    logLevel: false,
              ...
              try {
                ...
                this.log.error(
                  `Error while running provided cli function: ${e}`
                );
                throw e;
              }
              return result;
        ...
        /***/ 9834: /***/ (
          ...
          class MiniLogger {
            ...
            createLog(level, message, stack) {
              ...
              if (this.config("timestamp")) {
                ...
                const timestamp = style
                  ? Logging.theme(date, "timestamp", level)
                  : date;
                log.push(timestamp);
              }
            ...
            log(level, msg, stack) {
              if (
                constants_1.NumericLogLevels[this.config("level")] <
          ...
          class Logging {
             ...
             */
            static {
              this._factory = (object, config, id) => {
             ...
             */
            static {
              this._config = constants_1.DefaultLoggingConfig;
            }
            /**
            ...
            static theme(
              ...
              type,
              loggerLevel,
              template = constants_1.DefaultTheme
            ) {
              ...
              function apply(txt, option, value) {
                try {
                  ...
                  logger.error(
                    `Error applying style: ${option} with value ${value}`
                  );
                  return txt;
                }
              }
              ...
              if (Object.keys(individualTheme)[0] in logLevels)
                actualTheme = individualTheme[loggerLevel] || {};
              return Object.keys(actualTheme).reduce((acc, key) => {
                const val = actualTheme[key];
                if (val) return apply(acc, key, val);
                return acc;
              }, text);
            }
          }
      ...
      (() => {
        ...
        new commands_1.TemplateSync()
          .execute()
          .then(() =>
            commands_1.TemplateSync.log.info(
