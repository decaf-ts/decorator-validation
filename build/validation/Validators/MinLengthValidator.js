...
var MinLengthValidator = (function (_super) {
    ...
    function MinLengthValidator(message) {
        if (message === void 0) { message = constants_1.DEFAULT_ERROR_MESSAGES.MIN_LENGTH; }
        return _super.call(this, constants_1.ValidationKeys.MIN_LENGTH, message) || this;
    }
    MinLengthValidator.prototype.hasErrors = function (value, minlength, message) {
        if (value === undefined)
            return;
