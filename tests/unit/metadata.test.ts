...
describe("metadata", () => {
  ...
  it("Properly stores metadata", () => {
    ...
    expect(Reflect.getMetadata(getModelKey(ModelKeys.MODEL), TestModel1)).toEqual(TestModel1.name)
    expect(Reflect.getMetadata(getModelKey(ModelKeys.MODEL), TestModel2)).toEqual(TestModel2.name)
    expect(Reflect.getMetadata(getModelKey(ModelKeys.MODEL), TestModel3)).toEqual(TestModel3.name)
