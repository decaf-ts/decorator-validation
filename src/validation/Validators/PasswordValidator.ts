...
import {DEFAULT_ERROR_MESSAGES, PasswordPatterns, ValidationKeys} from "./constants";
...
export class PasswordValidator extends PatternValidator {
    ...
    constructor(errorMessage = DEFAULT_ERROR_MESSAGES.PASSWORD, passwordPattern: RegExp = PasswordPatterns.CHAR8_ONE_OF_EACH) {
